...
function App() {
  ...
  return (
    <>
      ...
      <div style={{ marginBottom: "16px", display: "flex", gap: "8px" }}>
        <ButtonTailwind variant={"secondary"}>test</ButtonTailwind>
        <ButtonTailwind variant={"primary"}>test</ButtonTailwind>
        <ButtonTailwind variant={"danger"}>test</ButtonTailwind>
      </div>
